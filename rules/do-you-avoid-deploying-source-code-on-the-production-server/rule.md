...
![PublishWebsite.jpg](PublishWebsite.jpg)Figure: How to open **Publish Web Site** dialog box![PublishWebsiteDialog.JPG](PublishWebsiteDialog.JPG)​​ Figure: **Publish Web Site** dialog box    See more about [Publishing Web Sites](https://msdn.microsoft.com/en-us/library/20yh9f1b.aspx).
...
![PublishWebApp.jpg](PublishWebApp.jpg)Figure: How to open **Publish Web** dialog ('WebApp' is the name of this application)​![PublishWebAppDialog.JPG](PublishWebAppDialog.JPG) Figure: **Publish Web **dialog box​​<br>          See more about [How to Publish Web Applications](https://msdn.microsoft.com/en-us/library/aa983453.aspx).
