...
![Level 2 Documentation includes database build scripts. We use <br>](instructions-level2.jpg)[SSW SQL Deploy](http://sqldeploy.com/) to make keeping all databases on the same version simple. Check out <br>      [how to use SQL Deploy here](http://tv.ssw.com/969/adam-stephensen-sql-deploy-demo)
