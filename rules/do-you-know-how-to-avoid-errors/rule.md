...
![avoid-errors-sp-migration1.png](avoid-errors-sp-migration1.png)Bad example: Page customized using SharePoint Designer![avoid-errors-sp-migration2.png](avoid-errors-sp-migration2.png)Good example: Out of the box list view page
