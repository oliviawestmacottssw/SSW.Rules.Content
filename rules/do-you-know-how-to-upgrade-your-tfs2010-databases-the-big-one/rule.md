...
![coffee.png](/PublishingImages/ssw-coffee.png)
...
![tfs_upgrade_existing.png](/PublishingImages/tfs_upgrade_existing.png)
...
![tfs_restore_dbs.png](/PublishingImages/tfs_restore_dbs.png)
...
![tfs_config_db.png](/PublishingImages/tfs_config_db.png)
...
![tfs_config_reporting.png](/PublishingImages/tfs_config_reporting.png)
...
![tfs_warehouse.png](/PublishingImages/tfs_warehouse.png)
...
![tfs_reports_run_as.png](/PublishingImages/tfs_reports_run_as.png)
...
![tfs_sharepoint.png](/PublishingImages/tfs_sharepoint.png)
23. Confirm the details on the Summary page and click Verify
![tfs_summary.png](/PublishingImages/tfs_summary.png)
...
![tfs_final_configure.png](/PublishingImages/tfs_final_configure.png)
25. Have a coffee
![coffee.png](/PublishingImages/ssw-coffee.png)
26. Click Next
![tfs_upgrade_complete.png](/PublishingImages/tfs_upgrade_complete.png)
27. Click Close, then Close again.
28. Change the DNS entries for your TFS server to point to the new TFS 2012 server
![tfs_dns.png](/PublishingImages/tfs_dns.png)
