...
Remember to make the "logged in" state clear enough to help the user know the current state.
   ...
   </dt><dd>Figure&#58; Good Example on Web form - Logged off state</dd></dl><dl class="ssw15-rteElement-ImageArea">   <img src="/PublishingImages/MetroLoggedIn.jpg" alt="MetroLoggedIn.jpg" style="margin&#58;5px;"></dl><dd class="ssw15-rteElement-FigureGood">Figure&#58; Good Example – Metro UI’s new logged in state 
   <br></dd>
