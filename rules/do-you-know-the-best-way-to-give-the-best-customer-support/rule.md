...
- [Skype for Business (previously Lync)](http&#58;//products.office.com/en/lync/lync)
...
- [Copilot](http&#58;//www.ssw.com.au/ssw/Standards/Support/RemoteSupportViaCopilot.aspx). This is a last option, and does not require changes to firewalls at either end (not free)​​.
