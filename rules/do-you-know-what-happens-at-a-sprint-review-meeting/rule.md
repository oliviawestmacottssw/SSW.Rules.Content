...
---
 ...
 This is the meeting where the Product Owner accepts or rejects the stories in the Sprint and the Sprint itself.  <br>   The Team, having [prepared](/Standards/Management/RulesToBetterScrumUsingTFS/Pages/PrepareForMeetings.aspx) for the meeting, presents the stories to the Product Owner.  
