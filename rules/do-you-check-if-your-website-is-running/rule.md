...
1. Add your website as a new device.  ![ New device](running1.GIF) 
2. Ping monitor is added automatically.  ![ Ping monitor](running2.GIF) 
3. Add an HTTP Content Scan monitor.  ![ HTTP Content Scan](running3.GIF) 
...
5. Add the monitor to your device.  ![ Add monitor Once a device is down or up, a WhatsUp action will tell SQL Reporting Services to send out a notification report. ](running5.GIF) 
Our report looks like this:  ![ Website doesn't work](running6.GIF) 
