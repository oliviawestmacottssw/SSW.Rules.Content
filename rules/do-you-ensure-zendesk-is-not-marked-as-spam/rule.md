...
![bypass-spam-filtering.png](bypass-spam-filtering.png)Figure: Bypass spam filtering setting in Exchange
...
![adding-domain-to-bypass-list.png](adding-domain-to-bypass-list.png)Figure: Adding domain to bypass list​
