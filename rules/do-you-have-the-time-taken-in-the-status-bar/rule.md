...
Also for a developer, you can use it to know if a piece of code you have modified has increased the performance of the task or hindered it.
 ​​​![TimeTaken_Bad.jpg](TimeTaken_Bad.jpg)Figure: Bad example - popup dialog at the end of a long process![TimeTaken_Good.jpg](TimeTaken_Good.jpg)Figure: Good example - show time taken in the status bar​
