...
![bad interview positions.jpg](bad-interview-positions.jpg) Figure: Bad example - Interviewee (left) is facing toward the interviewer (right) too much and the interviewer is faced towards the camera too much. ![interview positions.jpg](interview positions.jpg) Figure: Good example - position your subjects properly to create an unbiased interview. When doing an over the shoulder shot (OTS) for a corporate video, it is generally best to stay at a level height with the subject. Looking up or down at them can create unnecessary meaning in the shot. It is also a good idea to avoid using the wide angle setting on your camera as it makes the subject seem distant and small in comparison to the person whose shoulder we can see. ![bad OTS example.jpg](bad OTS example.jpg) Figure: Bad example – looking down at the subject with a wide angle lens setting. ![Good OTS example.jpg](Good OTS example.jpg)Figure: Good example – level height, zoom level not set to wide angle.
