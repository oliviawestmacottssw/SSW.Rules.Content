...
Efficient people don't rely on their memory and instead, use some way to make sure they don't forget to do that task. The most common ways are to either make a note in a paper diary, stick a post-it note to his screen. But there are better ways.​
 ![postit-screen.jpg](postit-screen.jpg) Figure: Bad example - using stick notes
...
When you receive it in your inbox, action the task.
 ![delay-emails-outlook.jpg](delay-emails-outlook.jpg) Figure: Good example - Use delayed email on Outlook 
...
​Simply BCC or email **@followupthen.com** and it will send you an email when that time expires, reminding you to follow up with another email.
 ![followupthen](FollowUpThen.jpg) Figure: Good example -  Use 1week@followupthen.com to be reminded of this email in one week
...
1. Click the Follow Up button ![followup1.jpg](followup1.jpg)Figure: Set a follow-up date
2. Select an appropriate date from the drop-down or choose Custom to add additional reminders ![followup2.jpg](followup2.jpg)Figure: Add an additional reminder to follow up
    - You can even set a custom reminder for the recipient :)
3. Outlook shows an info tip with the exact follow-up date you chose.
4. A To-Do item is also added to your Outlook To-Do list ![followup3.jpg](followup3.jpg)Figure: An item is added to your To-Do list 
