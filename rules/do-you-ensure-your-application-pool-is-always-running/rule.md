...
3. Open Advanced settings <br>      ![ IIS](iis8-1.jpg)
4. Change the “start mode” to “Always running” <br>      ![ Start mode](iis8-2.jpg)
5. Change Preload Enabled to True <br>      ![ Preload setting](iis8-3.jpg)
...
3. Select the server
4. Scroll down and select <br>      **Configuration Editor**![ IIS](iis7-1.jpg)
5. From the <br>      **Section** menu select <br>      **system.applicationHost / applicationPools**![ Configuration editor](iis7-2.jpg)
...
8. In the <br>      **Properties** window, scroll down and select <br>      **startMode**, choose <br>      **AlwaysRunning**![ Set "start Mode"](iis7-3.jpg)
