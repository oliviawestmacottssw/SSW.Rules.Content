...
3. Open Advanced settings <br>      ![](iis8-1.jpg)Figure: IIS
4. Change the “start mode” to “Always running” <br>      ![](iis8-2.jpg)Figure: Start mode
5. ​Change Preload Enabled to True <br>      ![](iis8-3.jpg)Figure: Preload setting
...
3. Select the server
4. Scroll down and select <br>      **Configuration Editor**![](iis7-1.jpg)Figure: IIS
5. From the <br>      **Section** menu select <br>      **system.applicationHost / applicationPools**![](iis7-2.jpg)Figure: Configuration editor
...
8. In the <br>      **Properties** window, scroll down and select <br>      **startMode**, choose <br>      **AlwaysRunning**![](iis7-3.jpg)Figure: Set "start Mode"
