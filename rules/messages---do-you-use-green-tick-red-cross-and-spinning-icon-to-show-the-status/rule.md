...
It is very important to use a clear information icon to show the current status. The icon should be consistent with the actual status.
   ​![inconsistent icon and actual status](../../assets/wrongIconStatus.gif)Figure: Bad Example - The icon is not consistent with the actual status![spinning icon to show status](../../assets/spinningIconStatus.gif)Figure: Good Example - Use spinning icon to show the checking status![cross icon to show status](../../assets/crossIconStatus.gif)Figure: Good Example - Use red cross icon to show the wrong status![green tick icon to show status](../../assets/tickIconStatus.gif)Figure: Good Example - Use green tick icon to show the correct status
