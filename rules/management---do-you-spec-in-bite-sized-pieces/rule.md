...
The first problem with specs is that nobody writes them. Joel Spolsky [says](http&#58;//www.ssw.com.au/ssw/Redirect/JoelOnSoftwareSpecs.htm) ![Leave Site](http&#58;//www.ssw.com.au/ssw/Images/LeaveSite.gif)

"Writing specs is like flossing: everyone agrees that it's a good thing, but nobody does it". 
 - Joel Spolsky, [The Joel Test: 12 Steps to Better Code](http&#58;//www.ssw.com.au/ssw/Redirect/JoelOnSoftwareSpecs.htm)We know developers like writing code more than specs, but the rule is developers don't code without a spec (including a release plan).
