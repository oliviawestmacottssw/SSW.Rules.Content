...
![Source Safe VB6](/PublishingImages/SourceSafeVB6.gif)Figure: You can also check-in automatically in VB6 
...
![Source Safe Access](/PublishingImages/SourceSafeAccessOptions.gif)Figure: You can also check-in automatically in Access ![Source Safe Access Menu](/PublishingImages/SourceSafeAccessMenu.gif)Figure: All the basic functions are easily accessible. 
