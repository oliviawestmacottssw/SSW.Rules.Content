...
![exploratory_2.png](exploratory_2.png)Figure: Bad Example - go to the Test tab, choose Do Exploratory Testing, choose a PBI, then click Explore. Too many steps​
![exploratory_1.png](exploratory_1.png)
...
![show_criteria.png](show_criteria.png)Figure: Clicking on the title will show you the Acceptance Criteria
...
![create_bug.png](create_bug.png)Figure: Creating a bug from exploratory test links to the PBI
...
![change_bug_steps.png](change_bug_steps.png)Figure: You can change the repro steps captured in the bug very easily
...
![save_create_test.png](save_create_test.png)Figure: Click Save and create test to create a matching test case
Again, the steps are prepopulated from your bug steps.
![create_test.png](create_test.png)Figure: The test steps are prepopulated from the action recording
### Related Links
