...
![Teams | Team | Files. More at](Microsoft-Teams-Files.png)
[https://rules.ssw.com.au/track-project-documents](/_layouts/15/FIXUPREDIRECT.ASPX?WebId=3dfc0e07-e23a-4cbb-aac2-e778b71166a2&TermSetId=07da3ddf-0924-4cd2-a6d4-a4809ae20160&TermId=c34a016c-d126-4e10-859e-4a0bbd2f08a6)
...
[[badExample]]
| ![It might be easy to use File Shares, your Local C: or emails – but don’t. They don’t work in a team environment as they aren’t easy for others to access](Dont-keep-files.jpg)
[[badExample]]
| ![SharePoint integrated into Azure DevOps](keep-files-TFS.jpg)(was VSTS/TFS) is not supported via Visual Studio anymore
[[badExample]]
| ![even though this is using SharePoint - this is using a Team Site with a Document Library - it is better to use Microsoft Teams which uses SharePoint under the covers](keep-files-SP.jpg)
![Use Microsoft Teams and it will automatically create a Site for the Team](keep-files-sp-teams.jpg)(and that includes a document library which you can connect to with OneDrive)
