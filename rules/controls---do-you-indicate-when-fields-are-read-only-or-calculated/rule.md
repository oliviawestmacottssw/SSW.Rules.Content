...
![Grey Field](../../assets/GreyField.gif)Figure: Good Example - Read only fields should be greyed out![Grey Field Excel](../../assets/GreyField-Excel.gif)Figure: Good Example - Calculated Fields in Excel should be in Grey
