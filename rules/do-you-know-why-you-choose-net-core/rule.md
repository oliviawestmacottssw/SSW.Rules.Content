...
.NET Core is fast, and you get that performance out of the box.
 ![dotnet-core-performance.jpg](dotnet-core-performance.jpg)Figure: ASP.NET Core easily trounces ASP.NET 4 in number of requests per second ([view source](https://www.ageofascent.com/2016/02/18/asp-net-core-exeeds-1-15-million-requests-12-6-gbps/))​
