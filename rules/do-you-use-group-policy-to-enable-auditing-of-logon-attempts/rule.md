...
![ Successful and Failed login attempts will now appear in Event Viewer | SecurityNow when you will have access to seeing success/failed login attempts on user accounts, these can then be captured and audited with your own internal process or a third party application such as Whats Up Gold, see: ](failed-login-3.png)
