...
<br>            IAsyncResult r = request.BeginGetResponse(new AsyncCallback(ResCallBack), request);
<br>         }
...
![](/PublishingImages/AsyncCallBack-Rulest1.gif) Figure: Automatically generated asynchronous methods
