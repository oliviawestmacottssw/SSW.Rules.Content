...
- Use good captions - See Do you add useful and bold figure text (aka a caption) to avoid a lot of text over images?
- Use good HTML - See Do you use the right HTML/CSS code to add the useful figure/caption?
