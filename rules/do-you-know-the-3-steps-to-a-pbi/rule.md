...
​Congrats. Your PBI is now ready to be demonstrated during your Sprint Review! (Note: This is also the same process you follow for a Bug work item)![3StepsToAPBI.jpg](/SiteAssets/do-you-know-the-3-steps-to-a-pbi/3StepsToAPBI.jpg)​ Good Figure: This image includes all the important steps in a PBI lifecycle. Print this "[SSW 3 Step​s to a PBI pdf](/Documents/3StepsToAPBI.pdf)" and put it on your 'War Room' wall
