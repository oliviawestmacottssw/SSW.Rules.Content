...
![ Adding a new "Test" state. This is only visible in the Product Backlog and not the Sprint Backlog![Testing task.png](Testing-task.png)](KB-customize-board-columns.png)
...
Congrats. Your PBI is now ready to be demonstrated during your Sprint Review! (Note: This is also the same process you follow for a Bug work item)![ This image includes all the important steps in a PBI lifecycle. Print this "[SSW 3 Steps to a PBI pdf](/Documents/3StepsToAPBI.pdf)" and put it on your 'War Room' wall](3StepsToAPBI.jpg) Good
