...
​​When using MediatR within an ASP.NET Controller it is typical to see actions such as the following:
 ![improve-mediatr-typical.png](improve-mediatr-typical.png)Figure: A Typical ASP.NET Controller using Mediator
...
![improve-mediatr-bad.png](improve-mediatr-bad.png)Figure: Bad Example - The request is contained within CreateProductCommand.cs
![improve-mediatr-bad-2.png](improve-mediatr-bad-2.png)Figure: Bad Example - The request handler is contained within CreateProductCommandHandler.cs
...
![business-logic-presentation-layer-good.png](improve-mediatr-good.png)Figure: Good Example - Nesting the Request Handler within the Request Improves Discoverability of Command and Associated Command Logic
