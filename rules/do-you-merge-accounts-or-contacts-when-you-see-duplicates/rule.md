...
[[badExample]]
| ![a developer would not know which record to use to track timesheets against](crm-duplicate-bad.jpg)
[[goodExample]]
| ![records merged to remove duplicates](crm-duplicate-good.jpg)
