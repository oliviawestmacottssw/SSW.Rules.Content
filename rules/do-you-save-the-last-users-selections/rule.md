...
[[badExample]]
| ![ Bad Example - This is suitable for first view, but not for a return view](../../assets/SampleSelect.jpg)

[[goodExample]]
| ![ Good Example - Instead, save the users last selection](../../assets/SampleSelect2.jpg)
