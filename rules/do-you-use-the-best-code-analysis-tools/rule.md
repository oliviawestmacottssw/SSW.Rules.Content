...
The gold standard is to use [Sona​rQube](https&#58;//www.sonarqube.org/), which gives you the code analysis that the previous levels give you as wells as the ability to analyse techincal debt and to see which code changes had the most impact to technical debt
