...
The gold standard is to use [Sona rQube](https&#58;//www.sonarqube.org/), which gives you the code analysis that the previous levels give you as wells as the ability to analyze technical debt and to see which code changes had the most impact to technical debt
 ![2016-06-08_12-59-38.png](/SiteAssets/do-you-use-the-best-code-analysis-tools/2016-06-08_12-59-38.png)  Figure:  SonarQube workflow with Visual Studio and TFS
