...
[[badExample]]
| ![ Bad Example – The printed layout looks nothing like the HTML ](print-reports-bad-2.png) 

![ Beautiful PowerBI HTML report ](print-reports-bad-3.png) 

[[badExample]]
| ![ Bad example – PowerBI print preview scales everything down to fit on a page, you have no real control over how things flow onto multiple pages](print-reports-bad-4.png) 
