...
1. Profile the application with Jetbrains dotTrace using the "Hot Spot" tab to identify the slowest areas of your application<br>    ![](/PublishingImages/JetBrainsProfilerHotSpots.jpg) Figure: Identify which parts of your code take the longest (Hot Spots)
