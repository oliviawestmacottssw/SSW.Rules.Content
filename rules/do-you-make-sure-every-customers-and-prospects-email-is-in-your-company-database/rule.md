...
<br>We have a program called [SSW LookOut! for Outlook](http&#58;//www.ssw.com.au/ssw/LookOut/) to check for this rule. ![Stephen Koop not in database](/PublishingImages/StephenKoopIsNotInTheDatabase.jpg) Figure: Stephen Koop needs to be put into the database
![Not in database](/PublishingImages/NotInDatabase.gif) Figure: SSW Lookout! Can also check the emails that you are sending and tell you if the email address is not in your database.
