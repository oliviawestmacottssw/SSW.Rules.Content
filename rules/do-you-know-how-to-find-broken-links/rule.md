...
[Google webmaster tools](https://www.google.com/webmasters) and [Bing webmaster centre](http://www.bing.com/toolbox/webmaster/) are useful tools to monitor links.
 ![ In Google webmaster tools you can see all broken URLs, and even the pages who are linking to them (known as referrer, found in the 'Linked From' column) ![In Bing webmaster center you can find the broken URL which is linked by the above URL](BingWebMaster.jpg) ](GoogleWebMaster.jpg) 
