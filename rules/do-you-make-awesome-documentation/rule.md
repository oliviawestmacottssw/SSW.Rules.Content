...
**6. Wiki\Definition-of-Done** - Ensures that your team [maintains a high level of quality with a Definition of Done](/Done-DefinitionOfDone)

**7. Wiki\Definition-of-Ready** – Ensures that all your PBIs are well defined to an agreed standard before adding them to a sprint (see:        [https://rules.ssw.com.au/have-a-definition-of-ready](/Definition-of-Ready))
...
::: greybox
**Tip** : All of your documents (in your Wiki and your repository) should be written in Markdown (see: <br>   [https://rules.ssw.com.au/using-markdown-to-store-your-content](/Using-GitHub-and-Markdown-to-store-you-content))
:::
...
This should be added to the        [Definition of Done](/Done-DefinitionOfDone).
...
Warning: if you want to follow Scrum and have zero technical debt, then you must throw away all documentation at the end of each sprint. If you do want to keep it, make sure you add it to your [definition of done](/Done-DefinitionOfDone)to keep it updated.
