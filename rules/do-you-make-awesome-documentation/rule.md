   ...
   <br> 
         ...
         <b>Tip&#58;</b> File with rich content such as Markdown or&#160;Microsoft Word documents are preferred over .txt files because images and formatting are important.<br></p><p>Here's a suggestion of what these documents could contain.&#160;<br></p><ol><li>Project structure 
               <p>All parts that compose the project and how they work with each other.</p><dl class="image"><dt>
                  ...
                  </dt><dd> Figure&#58; Architecture diagram of the&#160;project created with 
                     <a href="https&#58;//diagrams.net/">diagrams.net​</a> (used to be draw.io) </dd></dl></li><li>Third-party components 
               ...
               <br></li><li>Other things to take care of<br></li></ol><dl class="badImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__bad-example-gh.png" alt="documentation__level2__bad-example-gh.png" style="margin&#58;5px;width&#58;750px;height&#58;695px;" /> 
               <br> 
            </dt><dd>Bad example - Github project without any documentation or instruction. </dd></dl><dl class="goodImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__good-example-1-gh.png" alt="documentation__level2__good-example-1-gh.png" style="margin&#58;5px;width&#58;750px;height&#58;783px;" /> 
               <br> 
            </dt><dd class="ssw15-rteElement-FigureGood">Good example - Github&#160;project with ​README instructions on how to compile and run the project<br></dd></dl><dl class="goodImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__good-example-2-gh.png" alt="documentation__level2__good-example-2-gh.png" style="margin&#58;5px;width&#58;750px;height&#58;716px;" />
               <br> 
            </dt><dd class="ssw15-rteElement-FigureGood">​​​​Good example - Github&#160;project with Wiki instructions for product owners, stakeholders, or public consumption</dd></dl><dl class="badImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__bad-example-ad.png" alt="documentation__level2__bad-example-ad.png" style="margin&#58;5px;width&#58;750px;height&#58;611px;" /> 
               <br> 
            </dt><dd class="ssw15-rteElement-FigureBad">​Bad example - Azure DevOps project without any documentation or instruction<br></dd></dl><dl class="goodImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__good-example-1-ad.png" alt="documentation__level2__good-example-1-ad.png" style="margin&#58;5px;width&#58;750px;height&#58;611px;" /> 
               <br> 
            </dt><dd class="ssw15-rteElement-FigureGood">Good example - Azure DevOps project&#160;with ​README instructions&#160;on how to compile&#160;and run the&#160;project<br></dd></dl><dl class="goodImage"><dt> 
               <img src="/SiteAssets/do-you-review-the-documentation/documentation__level2__good-example-2-ad.png" alt="documentation__level2__good-example-2-ad.png" style="margin&#58;5px;width&#58;750px;height&#58;611px;" /> 
               <br> 
            </dt><dd class="ssw15-rteElement-FigureGood">Good example - Azure DevOps&#160;project with Wiki instructions for product owners, stakeholders, or public consumption<span style="color&#58;#444444;">​</span><br></dd></dl><h3 class="ssw15-rteElement-H3">Level 3&#58; Go Markdown<br></h3><dl class="image"><dt> 
               <img src="/PublishingImages/vsts-wiki.jpg" alt="vsts-wiki.jpg" style="width&#58;750px;height&#58;550px;" /> 
