...
![](realtime-workflow.png)Figure: Create the Workflow 
...
![](realtime-workflow-2.png)Figure: Stop and cancel if ‘Est Value’ greater than $100,000
...
![](realtime-workflow-3.png)Figure: Lead cannot be saved if Est value is greater than $100,000
