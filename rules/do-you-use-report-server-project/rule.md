...
If you have some reports and want to check them into source control, if you add them to project that is not a report project, your reports will not open in the design/preview view (allowing to see the DataSource and DataSets). They will open in the XML view (which is not pretty to work with).
 ![report-server-project1.png](report-server-project1.png)Figure: Bad example – C# project with reports opening as XML
...
![report-server-project2.png](report-server-project2.png)Figure: Checking Microsoft Reporting Services Projects is installed
...
![report-server-project4.png](report-server-project4.png)Figure: Good Example – Report Server project with reports opening in the design/preview view
