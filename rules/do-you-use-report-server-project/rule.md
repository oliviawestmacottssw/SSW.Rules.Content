...
[[badExample]]
| ![C# project with reports opening as XML](report-server-project1.png)
...
[[goodExample]]
| ![Report Server project with reports opening in the design/preview view](report-server-project4.png)
