...
<img alt="" class="ms-rteCustom-ImageArea" src="OptionStrictOff_Newsmall.gif" /> <font class="ms-rteCustom-FigureBad">Figure:Bad Example – Option Strict is Off</font><img alt="" class="ms-rteCustom-ImageArea" src="OptionStrictOn_Newsmall.gif" /> <font class="ms-rteCustom-FigureGood">Figure:Good Example – Option Strict is On </font>
