...
![](/PublishingImages/Google-analytics.png)Figure: Google analytics show​ing user stats


 

For similar reasons, you shouldn't deploy a web application without metric tracking on performance and exceptions.
![](/PublishingImages/App-Insights-Dashboard.png)Figure: Application insights showing application stats
