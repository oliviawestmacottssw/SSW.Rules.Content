...
![  When developing a public website, you wouldn't deploy without Google Analytics to track metrics about user activity.  ](Google-analytics.png) 

![ For similar reasons, you shouldn't deploy a web application without metric tracking on performance and exceptions](2020-03-24_15-27-26.jpg) 
...
![ Spikes on an Echidna are dangerous  ](../../assets/r437355_2104314.jpg)  

![ Spikes on a graph are dangerous](../../assets/sockeye-daily-count.jpg)  
