...
![](Bad example C4.jpg)Throw away your remote controls and move on to technological freedom!
...
If you need to change the user or sign in with new credentials, you can use the following steps to do so:Once logged in, you will have access to your site's controls. These apps are customisable, but the ones we have at SSW are:
...
> 2. Scroll to the bottom andselect the settings button.
