...
Also, never forget to do incremental changes in your tests!For example, if you are trying to measure the optimal number of processors for a server, do not go from 1 processor to 4 processors at once:![1to4.png](/PublishingImages/1to4.png)Figure: Bad Example - Going from 1 to 4 all at once gives you incomplete measurements and data
Do it incrementally, adding 1 processor each time, measuring the results, and then adding more:![1234.png](/PublishingImages/1234.png)Figure: Good Example - Going from 1 to 2, then measuring, then incrementally adding one more, measuring...This gives you the most complete set of data to work from.
