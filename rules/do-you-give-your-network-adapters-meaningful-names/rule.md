...
[[badExample]]
| ![ Bad Example - It makes it hard to know what network adapter does what if you don't have meaningful names](naming-bad.jpg)

[[goodExample]]
| ![As an example naming convention for network adapters on each node](naming-good.jpg)

[[goodExample]]
| ![ Good Example - It is easy to tell which network adapter does what when they have meaningful names](naming-good2.jpg)
