...
See the [SSW Menu Estimates Calculator](/Management/RulesToBetterProjectManagement/Pages/ReleaseEstimationProcess.aspx)(NOTE: this is an Excel template file.  Save the File ("Save as" don't "Open" it) and then open the file in Windows Explorer!)
...
Note: It would be great if TFS Web Access had functionality “Add [Standard Items](http&#58;//www.ssw.com.au/ssw/Standards/BetterSoftwareSuggestions/TeamFoundationServer.aspx#StandardItems)to a Iteration (aka Sprint, Release etc.)”
