...
[[badExample]]
| ![using jQuery on Angular views will lead to worlds of pain](understand-badcode.png)
...
[[goodExample]]
| ![In both AngularJs & Angular 2.0 jQuery is not required on the view. The view binds to properties on a JavaScript model](understand-goodcode.png)
