...
![Compress Pictures](/PublishingImages/compress-pictures.jpg)Figure: "Compress Pictures" options dialog
...
![SharePoint Context menu](/PublishingImages/sharepoint-context-menu.jpg)Figure: If using SharePoint 2010 you should use this context menu
...
We have a program called [SSW LookOut! for Outlook](http&#58;//www.ssw.com.au/ssw/LookOut/) to check for this rule. ![Contact or Mail Size](/PublishingImages/ContactorMailSize.gif) Figure: SSW LookOut! for Outlook warns you if your mail size is large. 
