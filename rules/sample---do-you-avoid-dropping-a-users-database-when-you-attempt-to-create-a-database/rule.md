...
![Reporting Services Setup - Database Already Exists](../../assets/InterfacesDBAlreadyExists.gif)Good example – an application should never automatically delete a database, not even a sample database
