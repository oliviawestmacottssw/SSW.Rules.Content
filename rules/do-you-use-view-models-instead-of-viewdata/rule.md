...
::: greyboxFigure: Bad Example – ViewData being used to pass information to the View isn’t type-safe
...
::: greyboxFigure: Good Example – Using a ViewModel is a safer way to pass data
