...
![Links Example](LinksExample.gif)Figure: An exception to the rule - an "Update" button inside the datagrid would look inconsistent![Links Vs Button](LinkVsButton.gif)Figure: Bad Example - The "sign in" hyperlink should be a button![Correct sign in](Logon.gif)Figure: Good Example - This is a perfect example of how a good sign in screen should look
