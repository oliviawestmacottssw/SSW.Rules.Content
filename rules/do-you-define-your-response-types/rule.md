...
![bad-no-response-types.jpg](bad-no-response-types.jpg)<br>dd>​Figure: Bad example – no response types![good-response-types.png](good-response-types.png)Figure: Good example – Response types (in .NET) 
