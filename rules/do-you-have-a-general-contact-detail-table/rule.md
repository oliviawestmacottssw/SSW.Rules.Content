...
[[badExample]]
| ![A too specific Contact Detail table](ContactDetailTable_bad.png)
...
[[goodExample]]
| ![A general Contact Detail table](ContactDetailTable_good.png)
We use a Contact Detail Category table to store these categories.

[[goodExample]]
| ![Details of Contact Detail Category table](ContactDetailCategoryTable.png)
