...
Getting someone else to test the migration is the best wat to make sure that you have not missed anything.
...
![Add Team Foundation Serve](/TFS/RulesToBetterTFS2010Migration/PublishingImages/AddTeamFoundationServer.png) 
<font class="ms-rteCustom-FigureNormal" size="+0">Figure&#58; Remember to use the &quot;/tfs&quot; option when connecting to the new server.</font>
...
<br>        note: This will need to be done using Team Explorer 2010 as it is not supported in 2008.
