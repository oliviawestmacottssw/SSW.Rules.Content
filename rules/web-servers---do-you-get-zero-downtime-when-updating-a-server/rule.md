...
3. To view the current connections on the server, open a command prompt and enter netstat -an. You will be able to see the connections list dropping as users are sent to the other server ![netstat](/PublishingImages/Server-netstat.jpg) Figure: Run "netstat -an" to view the current connections on the server
...
![Server turns red](/PublishingImages/Server-red.jpg) Figure: When the server turns red, the connections have been dropped and you're ready to update
