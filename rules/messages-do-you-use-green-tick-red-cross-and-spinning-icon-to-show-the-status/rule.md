...
[[badExample]]
| ![The icon is not consistent with the actual status](../../assets/wrongIconStatus.gif)
[[goodExample]]
| ![Use spinning icon to show the checking status](../../assets/spinningIconStatus.gif)
[[goodExample]]
| ![Use red cross icon to show the wrong status](../../assets/crossIconStatus.gif)
[[goodExample]]
| ![Use green tick icon to show the correct status](../../assets/tickIconStatus.gif)
