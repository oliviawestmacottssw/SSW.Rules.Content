...
When redirecting users to another page make sure that the       text is consistent between the two pages.
 ![Consistent Information](http&#58;//www.ssw.com.au/SSW/Standards/Rules/Images/ConsistentInformation.gif)Figure: Good example - Click "More" and the next page begins with the same information
