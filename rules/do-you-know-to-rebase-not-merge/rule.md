...
![ When merging: a messy merge commit is created any time you need to incorporate upstream changes from the master branch ![rebase2.png](rebase2.png)](rebase1.png)
