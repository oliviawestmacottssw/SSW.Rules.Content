...
​Using a free third party tool AD Photo Edit tool which can be downloaded from [http://www.cjwdev.co.uk/](http&#58;//www.cjwdev.co.uk/) ![](/_LAYOUTS/15/Images/SSW/external.gif "You are now leaving SSW") ![](/_LAYOUTS/15/Images/SSW/external.gif "You are now leaving SSW") you can upload Staff profile pictures into AD. You need to run the application with Domain Admin rights. After you have uploaded the picture for a user it will take some time for the change to be replicated through to Exchange and Lync if you have use these solutions.

![ExchangeAdPhoto.jpg](/PublishingImages/ExchangeAdPhoto.jpg)

**Figure: Profile picture imported from AD into Exchange **

![LyncAdPhoto.jpg](/PublishingImages/LyncAdPhoto.jpg)
