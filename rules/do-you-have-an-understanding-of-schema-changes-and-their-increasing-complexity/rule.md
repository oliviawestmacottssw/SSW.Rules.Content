...
Figure: Change data type (Very Hard) e.g. Text to Integer. Text to Integer and data conversion requires[the full .SQL file](/Documents/EmployeesCharToInt.sql). The above is abbreviated, see["Data Motion Scripts"](/Pages/DoYouUnderstandADataTypeChangeDataMotionScripts.aspx)   
