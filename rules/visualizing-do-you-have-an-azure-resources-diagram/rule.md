...
::: bad  
![Figure: Bad Example – Using the Azure Portal to view your resources           Option B: Visually viewing the resources](azure resources.png)  
:::

::: good  
![Figure: Good Example – Viewing the resources in VS Code using the ARM Template Viewer extensionFigure: Good Example - ARM template and automatically generated Azure resources diagram in the SSW Rewards repository on GitHubFigure: Good Example - The Azure resources diagram generated by the ARM Template Viewer extension for SSW Reewards](AZURE-VIEW-GOOD.png)  
:::
