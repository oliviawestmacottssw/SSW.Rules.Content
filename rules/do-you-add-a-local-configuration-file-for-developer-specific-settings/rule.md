...
Resolve this by:
![local-config-file-1.png](local-config-file-1.png)Figure: #1 Create an appsettings.Local.json file. Set this to be ignored by your source code control system![local-config-file-2.jpg](local-config-file-2.jpg)Figure: #2 ​Add code to apply this configuration file in Program.cs
