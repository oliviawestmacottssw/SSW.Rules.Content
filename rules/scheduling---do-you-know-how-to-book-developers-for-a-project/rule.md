...
<dl class="image"><dt> <img alt="CRM Service Calendar" src="appointment-booking.jpg" style="width:95%;"> </dt><dd>Figure: A complete appointment booking Mark to work for Westlink for 5 days</dd></dl>
...
1. Create new appointment from the CRM 2016 web interface (also works in CRM 2013) <dl class="image"><dt> <img alt="New Appointment" src="appointment-new.jpg" style="width:95%;"> </dt><dd>Figure: Click Appointment to create a new appointment in CRM<br></dd></dl>
2. Set the Subject
...
<dl class="image"><dt> <img alt="Complete appointment" src="complete-appointment.jpg" style="width:95%;"> </dt><dd>Figure: A complete CRM Appointment for a 1-day booking</dd></dl>

### Option 3: CRM Service Activities (bad example)
<dl class="badImage"><dt> <img src="CRMServiceActivity.jpg" alt="CRMServiceActivity.jpg" style="width:95%;"> </dt><dd> Figure: Bad Example - Don't use Service Activities as they don't map as gracefully with Outlook Appointments</dd></dl>
