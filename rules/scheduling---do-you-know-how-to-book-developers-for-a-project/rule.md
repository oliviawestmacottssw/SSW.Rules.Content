...
1. Create new appointment from the CRM web interface  ![New Appointment](/PublishingImages/appointment-new.jpg) Figure: Click Appointment to create new appointment in CRM
2. Set the Subject
...
### Option 3: CRM Service Activities (bad example)
 ![CRMServiceActivity.jpg](/PublishingImages/CRMServiceActivity.jpg)  Figure: Bad Example - Don't use Service Activities as they don't map as gracefully with Outlook Appointments If you do not know who can do the work, but you know the type of resource required, you can use Service Activities.
