...
[[goodExample]]
| ![Azure website using AzureSearch for what it can deliver today](9c0754_Untitled2.png)



[[badExample]]
| ![Azure website using ElasticSearch for a simple search that AzureSearch can do](Untitled.png)
