...
<dl class="image"><dt><img src="onpremisesad2.png" alt="onpremisesad2.png"></dt><dd>Figure: CRM (Dynamics 365) used a source of truth</dd></dl> In this scenario, a custom sync mechanism (i.e. SSIS pipeline) will have to be implemented. Both Dynamics 365 and User Profile Service exposes APIs that can read and write properties/fields for such a system.
