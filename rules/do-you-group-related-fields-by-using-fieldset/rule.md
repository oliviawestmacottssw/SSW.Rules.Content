...
See the example below using "Your Details"                     and "Event Details".
 <dl class="goodImage"><dt><img src="/DesignandPresentation/RulestoBetterInterfacesForms/PublishingImages/fieldset.jpg" alt=""></dt><dd>Figure&#58; Good example - Use FieldSet for grouping</dd><dd></dd></dl>
