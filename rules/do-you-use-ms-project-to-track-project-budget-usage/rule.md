...
4. Your work items will be imported and arranged within a hierarchy. As we are trying to track the progress, we want to keep “Original Estimate”, “Remaining Work” and “Completed Work” together, so drag them after the Work Item Title.![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/ArrangeWorkItems_Small.jpg)Figure: Arrange your work items so we can easily track their progress
...
![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/AssignResourceRates.jpg)Figure: Assign resource rates
...
![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/CostColumn_Small.jpg)Figure: Showing the cost columns
...
![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/NoPublishAndRefresh.jpg)Figure: Don’t publish and refresh this summary task In order to make this a summary item you need to select all the other tasks and indent them. To achieve this click the little red forward arrow in the toolbar.
...
**Track your project on the go**
 ...
 To refresh your project file, simply click on the “Refresh” button in the toolbar. ![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/RefreshProject.jpg)Figure: Click the “Refresh” button to update your project file.![](/Standards/Management/RulesToBetterProjectManagement/PublishingImages/BudgetUsage_Small.jpg)Figure: Budget usage is calculated. Note: If you find that the values are not calculating properly, it may be that the calculation mode is set incorrectly. If pressing F9 updates the values you should change the setting “Tools | Options | Calculation” from “Manual” to “Automatic”.
