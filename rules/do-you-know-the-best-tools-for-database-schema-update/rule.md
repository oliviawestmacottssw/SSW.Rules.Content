...
* [Do you make sure that the database structure is handled automatically via 3 buttons "Create", "Upgrade" and "Reconcile"?](/DoYouMakeSureThatTheDatabaseStructureIsAutomaticallyHandledAutomaticallyVia3ButtonsCreateUpgradeAndReconcile)
