...
1. Open SQL Server Management Studio![](SqlServerAllYourRam_01.png)Figure: SQL Server Management Studio - Login Screen
2. Right click on the server name and select “Properties”![](SqlServerAllYourRam_02.png)
 **Figure: SQL Database options and properties menu**
3. Select the “Memory” tab ![](SqlServerAllYourRam_03.png) **Figure: Server Properties showing the ridiculously large value set for the maximum server memory**
4. You will see that the default number is HUGE. Change this to something more realistic. Let SQL use half of the memory in your server.Leave about 1024MB headroom. For example, if you server has 4GB of RAM, give the SQL server a Maximum server memory of 2048mb.![](SqlServerAllYourRam_04.png)
