...
Tip #2: Use inbox subfolders to group and prioritize tasks
 ![subfolders.png](subfolders.png) Figure: Group by subfolders under your inbox ![Tasks](tasks-illustration.jpg) Figure: Efficient people keep a priority list (often written)
...
Figure: Confirm with the client "Are you changing the prior order?" ![](prioritization.jpg) Figure: Prioritization - The most recent task assigned is not necessarily the most important. Mentally do this (e.g. an air traffic controller does not deal with the newest plane that has popped up on his radar when he has 4 lined up to land 
