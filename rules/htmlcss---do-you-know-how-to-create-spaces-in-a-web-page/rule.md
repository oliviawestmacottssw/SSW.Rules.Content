...
[[greyBox | Bad Example - Using the "space" ASCII character to create a padding on that list]]
|  <br>&lt;ul&gt;
| <br>&lt;li&gt;&#160;&#160;&#160;List item&lt;/li&gt;
| <br>&lt;/ul&gt;
| <br>
[[greyBox | Bad Example - Using the &lt;br /&gt; tag to create a space at the bottom of that list]]
|  <br>&lt;ul&gt;
| <br>&lt;li&gt;List item&lt;/li&gt;
| <br>&lt;/ul&gt;
| <br>&lt;br /&gt;
| <br>&lt;br /&gt;
| <br>&lt;br /&gt;<br>
[[greyBox | Good Example - Using CSS to add a margin at the bottom of the list a the padding on the left side of each list item]]
|  <br>ul {margin-bottom:15px;}
| <br>ul li {padding-left:10px;}<br>
