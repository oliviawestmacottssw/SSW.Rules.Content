...
![](/Communication/RulesToBetterCRMForUsers/PublishingImages/crm-automated-forms-1.png)Figure: ‘Customer Type Other’ should be hidden and only displayed when Other is selected
