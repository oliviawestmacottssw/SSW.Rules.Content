...
When building a simple API based on Entity Framework, It can be tempting to keep it simple and bind persistent entities directly to WebAPI output.
 ​![bad-webapi.png](bad-webapi.png)Figure: Bad Example -​ A naive WebAPI implementation
...
![bad-webapi-operation.png](bad-webapi-operation.png)Figure: Bad Example - A naive update operation
...
![good-webapi-1.png](good-webapi-1.png)![good-webapi-2.png](good-webapi-2.png)Figure: Good Example - Update an Entity from a submitted View Model
