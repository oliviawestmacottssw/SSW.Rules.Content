...
[[badExample]]
| ![No '-All-' option so the user cannot select all data<br>](../../assets/Combo-ALL-1.jpg)
[[goodExample]]
| ![Having an '-All-' option gives a user a chance to select all data<br>](../../assets/Combo-ALL-2.jpg)
Also, keep it simple!

[[badExample]]
| !['-All Stores-' isn't needed<br>](../../assets/SelectAllBad.jpg)
[[goodExample]]
| ![Keep it as a simple '-All-'<br>](../../assets/SelectAllGood.jpg)
[[goodExample]]
| ![Keeping it simple makes it easy to spot](../../assets/SelectAllVGood.gif)(that there is no filter) when you have multiple fields.<br>
