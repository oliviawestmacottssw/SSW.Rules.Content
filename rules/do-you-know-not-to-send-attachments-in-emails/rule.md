...
If you're sending to a client, it would be a link to a document store on their [project portal](/_layouts/15/FIXUPREDIRECT.ASPX?WebId=3dfc0e07-e23a-4cbb-aac2-e778b71166a2&TermSetId=07da3ddf-0924-4cd2-a6d4-a4809ae20160&TermId=846474eb-27a1-4645-90ee-10a349fef714). (e.g. projects.northwind.com/SharedDocuments)
 ![Forward client attachments](Email_Attachment_1_small.jpg)Figure: Bad example - Don't send attachments by mail ![PortalLinks.jpg](PortalLinks.jpg)Figure: Bad example - Don't use location / filename in the link (URL)
...
![OnePlaceMail.png](insert_link_in_email_to_sharePoint_item-png.png)Figure: Good Example - Use OnePlaceMail to send a link to a document in SharePoint
...
​![OnePlaceMail.png](insert_link_in_email_to_sharePoint_item_with_document_id-png.png)Figure: Good Example - The use of the SharePoint Document ID as part of the link (URL) formation
