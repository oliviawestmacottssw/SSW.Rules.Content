...
[[goodExample]]
| ![screen resolution set to 1920 x 10802. Start 'Camtasia Recorder' <br>](good resolution screenshot.jpg)
...
![Check the audio levels7. On the ‘Inputs’ tab, select ‘Device Properties’.](record-camtasia-3.jpg)
...
![In Camtasia, there are two options in the frequency setting to help prevent flickering.<br>   This setting ensures that the camera frame rate is in sync with electrical devices](frequency-settings-camtasia.png)(such as fluorescent lights) in order to prevent flickering.
