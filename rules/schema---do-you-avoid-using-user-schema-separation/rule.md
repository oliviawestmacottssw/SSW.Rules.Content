...
[[badExample]]
| ![ Bad Example - AdventureWorks using user schema - instead, keep it simple and avoid using user schema unnecessarily](SQLDatabases_UserSchema_Bad.jpg)

[[goodExample]]
| ![ Good Example - Adventure works with user schema cleaned out. Much simpler and more readable](SQLDatabases_UserSchema_Good.jpg)
