...
![ Bad example - dark wall on the side, boring wall in the middle, reflective surface with people passing behind, lack of depth.![good-set-example.png](good-set-example.png)](Bad-set-design-example.jpg)
###  <br>Location
...
![ Bad example - the light is far too bright in comparison to the rest of the shot.![Japan_by_dhatt1.jpg](Japan_by_dhatt1.jpg)](Lighting-bad-example-DSC_0023-small.JPG) 
###  <br>   Props
...
![ Bad example - too much clutter on the desk, unnecessary dirty bowl, loose sheets of paper, this would only work if you wanted to illustrate that the character is messy.![Props-good-example-DSC_0017.jpg](Props-good-example-DSC_0017.jpg)](Props-Bad-example-DSC_0016.JPG)
