...
![Bad-set-design-example.jpg](/PublishingImages/Bad-set-design-example.jpg)Figure: Bad example - dark wall on the side, boring wall in the middle, reflective surface with people passing behind, lack of depth.![good-set-example.png](/PublishingImages/good-set-example.png)Figure: Good example - interesting background but not distracting, relevant furniture, set reflects theme of show
###  <br>Location
