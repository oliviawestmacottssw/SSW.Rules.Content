...
[[goodExample]]
| ![Google Chrome Lighthouse is showing 100%](lighthouse-100.png)
...
[[goodExample]]
| ![Lighhouse can simulate slow netwrking and CPU when performing tests](lighthouse_throttling.png)
