...
[greyBox] Sit with John Liu and he will get you up on our SharePoint image  [/greyBox]
Bad Example: Explain how to run the SharePoint image
[greyBox] Get the URL to the standard from our intranet, if the standard is unclear, check your changes with John Liu and then make them [/greyBox]
