...
1. Who the [Product Owner](/how-to-be-a-good-Product-Owner) is and who the [Scrum Master](/HelpScrumMasterProtectTheTeam) is
2. The [Definition of Ready](/Definition-of-Ready) and the [Definition of Done](/Done-DefinitionOfDone)
3. When the [daily standups](/DailyStandUpScrum) occur and when the next sprint review is scheduled
