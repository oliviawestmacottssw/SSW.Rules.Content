...
[[badExample]]
| ![ Bad Example - four images, one for each icon](ImageSprites_bad.gif)

[[goodExample]]
| ![ Good Example - one image contains all the icons and CSS selectors make the browser display only the part you need](ImageSprites_good.gif)
