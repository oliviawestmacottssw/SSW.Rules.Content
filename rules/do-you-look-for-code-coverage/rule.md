...
- You should run your tests regularly (see [Do you follow a Test Driven Process](/TFS/RulesToBetterVersionControlwithTFS%28AKASourceControl%29/Pages/TestDrivenProcess.aspx)). Ideally, they'll be part of your build (see [Do you know the minimum builds to create on any branch](http&#58;//www.ssw.com.au/ssw/Standards/Rules/RulesToBetterSourceControlwithTFS.aspx#MinimumBuilds))
