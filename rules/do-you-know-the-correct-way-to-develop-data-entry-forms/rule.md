...
Data Entrees should be able to use your data entry form with ease. It should follow the flow that they are familiar with.
 ![Access - Clients Form](../../assets/BadAddDeleteSubForm.gif)Figure: Bad Example - New button should open another form, and Delete button should be on that new form
...
![Centrix - Save Changes](../../assets/SaveChangesDialog.jpg)Figure: Good Example - Save Changes Dialog must appear when form is dirty
...
![Integrated Search](../../assets/BadSearch.gif)Figure: Bad Example - This implementation of a search utility is on the same form![Separate Search](../../assets/SearchForm.gif)Figure: Good Example - This implementation of Search feature is on a separate form
...
![Centrix - Loan Estimate Details](../../assets/SubFormsExample.gif)Figure: Good Example - No Delete button for Sub forms
5. ### Validation
...
![Centrix - File, Action, Report, Tools & Help Menus](../../assets/MenuBadExample.jpg)Figure: Bad Example - Action and Tools are irrelevant on this form![Centrix - File, Report & Help Menus](../../assets/MenuGoodExample.jpg)Figure: Good Example - Menus are relevant    In the above example, there are a couple of unused menus that have been inherited from the base form and not set to invisible.
7. ### Field Formatting
...
![SSW Time PRO .NET - Time Sheets](../../assets/BadCreatedUpdated.jpg)Figure: Bad Example - This form has no information to indicate who created this entry and who last modified it![SSW Time PRO .NET - Time Sheets](../../assets/GoodCreatedUpdated.jpg)Figure: Good Example - This form contains Created by/Updated by fields used in a standard control which is put into all forms    An example of how to set the values for this user control is shown below.
...
![User Control - Data Binding in the Designer](../../assets/CommonFieldsDB.gif)Figure: Data Binding using the Designer
9. ### Minimum Defaults
