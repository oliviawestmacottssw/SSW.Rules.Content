...
[[goodExample]]
| ![ Good Example - Outlook opens multiple instances of the data entry form ](../../assets/Outlookemails.jpg)
(email message)
[[goodExample]]
| ![ Good Example - Each form instance is shown in the taskbar, and easily opened again    A method of implementing this is through New and Delete buttons on the form.](../../assets/outlooktaskbar.jpg)
...
[[goodExample]]
| ![ Good Example - New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets    The Delete button resides there to make sure that Sally has seen the record before she deletes it. The New button should instantiate a new data entry form in add mode ](../../assets/GoodAddDeleteSubForm.jpg)
(as compared to "edit"), leaving the current one in the background.
...
[[badExample]]
| ![ Bad Example - This implementation of a search utility is on the same form](../../assets/BadSearch.gif)

[[goodExample]]
| ![ Good Example - This implementation of Search feature is on a separate form](../../assets/SearchForm.gif)
...
[[badExample]]
| ![ Bad Example - Action and Tools are irrelevant on this form](../../assets/MenuBadExample.jpg)

[[goodExample]]
| ![ Good Example - Menus are relevant    In the above example, there are a couple of unused menus that have been inherited from the base form and not set to invisible.](../../assets/MenuGoodExample.jpg)
...
[[badExample]]
| ![ Bad Example - This form has no information to indicate who created this entry and who last modified it](../../assets/BadCreatedUpdated.jpg)

[[goodExample]]
| ![ Good Example - This form contains Created by/Updated by fields used in a standard control which is put into all forms    An example of how to set the values for this user control is shown below.](../../assets/GoodCreatedUpdated.jpg)
