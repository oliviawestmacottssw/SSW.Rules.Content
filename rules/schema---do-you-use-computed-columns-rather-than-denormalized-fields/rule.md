...
![NormalizedFields_Good.jpg](NormalizedFields_Good.jpg)Figure: Good Example​ - There was no code in the middle tier to calculate this (and it has the correct name)
...
![NormalizedFieldsDefine.jpg](NormalizedFieldsDefine.jpg)Figure: Sett​ing up a computed column in the table designer​
