...
​<a href="http&#58;//angular.io/" target="_blank">Angular.io​</a> <img title="You are now leaving SSW" src="/Style%20Library/SSW/CoreImages/external.gif" alt="" />&#160;&#160; is a great place to get started learning Angular 2, and since the Angular CLI is now an official Angular Project, these docs now include using the CLI from the beginning.,<br>
