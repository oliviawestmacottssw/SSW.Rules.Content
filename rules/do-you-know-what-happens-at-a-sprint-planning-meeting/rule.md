...
The Product Owner is then asked to group the top ranking Bugs into Stories for inclusion in the Sprint; see this [rule](/Management/RulesToBetterScrumUsingTFS/Pages/BugsontheProductBacklog.aspx).
...
![](/Management/RulesToBetterScrumUsingTFS/PublishingImages/SprintWorkItem.jpg)Figure: A sample Sprint work item based on the Microsoft Scrum process template for TFS
