...
<ol>
    <li>Download <b>Solution Exporter </b>from <a href="http&#58;//www.crsw.com/mark/Lists/Posts/Post.aspx?ID=37">http&#58;//www.crsw.com/mark/Lists/Posts/Post.aspx?ID=37</a> and run it on the SharePoint 2007 server. This allows you to export the installed solutions from the source SharePoint server.</li>
