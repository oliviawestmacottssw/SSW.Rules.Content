...
<dl class="goodImage"><dt><img src="/PublishingImages/builds-success-good.jpg" alt=""></dt><dd>Figure&#58; Good Example – Check your build has passed from Team Explorer | Builds</dd></dl>
...
<dl class="goodImage"><dt><img src="/PublishingImages/builds-success-better.jpg" alt=""></dt><dd>Figure&#58; Better Example – Check your build(s) are continually passing by having the TFS Build Notification tool always running - Start | All Programs | Visual Studio 2012 | Team Foundation Server Tools | Build Notifications</dd></dl>
