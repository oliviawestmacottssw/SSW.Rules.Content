...
- Each keyframe should be half the distance on the timeline from the previous keyframe
 ...
 ![TextExpression-AfterEffects-TheSwingIn_BadExample.jpg](TextExpression-AfterEffects-TheSwingIn_BadExample.jpg)
Figure: Bad Example - this does not simulate gravity and will be jarring to the viewer
![TextExpression-AfterEffects-TheSwingIn.jpg](TextExpression-AfterEffects-TheSwingIn.jpg)
Figure: Good Example - Angle/time graphic for "Swing In" effect[!\[Swing-In.jpg\](Swing-In.jpg)](http://youtu.be/0ugMkda9IBw?t=7s)Figure: Good example – A well designed 'swing-in' effect can bring your titles to life - See 0:07 in this <br>      [video example](http://youtu.be/0ugMkda9IBw?t=7s)
