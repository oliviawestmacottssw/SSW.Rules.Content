...
![](acknowledgements.jpg)​Figure: This is where you add or remove "Acknowledgements"​
![](add-new-value.png)​Figure: Click on "Go to lookup list to add new value​" if the person is not on the list yet​
