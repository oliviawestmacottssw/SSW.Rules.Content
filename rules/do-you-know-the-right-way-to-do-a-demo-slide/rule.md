...
<dl>    <dt><img class="ms-rteCustom-ImageArea" src="DemoBad.gif" alt=""> </dt>
    <dd class="ms-rteCustom-FigureBad">Figure: Bad example - demo text shown. The problem is if you run out of time you need to say "Sorry, let's skip that demo since I am short of time". Then the audience feels cheated</dd></dl><dl>    <dt><img class="ms-rteCustom-ImageArea" src="demo.gif" alt=""> </dt>
