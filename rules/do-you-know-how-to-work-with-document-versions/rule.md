...
2. Make sure you are showing the version column in your document view. <br>      ![Add a version column](VersionColumn_Small.jpg)    TIP: You can add the column by selecting Modify View
3. Whenever you edit the document and check it in, SharePoint will automatically increase the version number.
    ...
    1. Save the file locally by selecting Send To | Download a Copy <br>         ![Save a file locally](SaveFileLocally_Small.jpg)
