...
![performance-1.jpg](performance-1.jpg)Figure: There are 3 spikes to investigate (one on each graph), but which is the most important? Hint: look at the scales!
...
![performance 2.png](performance 2.png)Figure: The 'Average of Browser page load time by URL base' graph will highlight the slowest page.
...
![performance-3.png](performance-3.png)Figure: In this case, the user agent string gives away the cause, Baidu (a Chinese search engine) got stuck and failed to index the page.
...
![performance-4.jpg](performance-4.jpg)Figure: In this case, the most important detail to action is the Get Healthcheck issue. Now you should be able to optimise the slowest pages​
