...
![when-use-value-bad.png](when-use-value-bad.png)Figure: Bad Example - Storing an AD Account as a String (AD Account is a complex type)
...
![when-use-value-good.png](when-use-value-good.png)​
...
![when-use-value-good-2.png](when-use-value-good-2.png)Figure: Good Example - Implementation of the AdAccount Value Object Supports Logic and Validation
...
![when-use-value-eg-2.png](when-use-value-eg-2.png)Figure: Using Entity Framework Core to Configure Value Objects as Owned Entity Types
