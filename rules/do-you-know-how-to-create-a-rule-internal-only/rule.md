...
4. Click on “Add a page” <dl class="image"><dt> <img alt="Create Rule" src="create-rule1.jpg"> </dt><dt></dt></dl>   **Note:** Each rule will be a “page” on SharePoint – with its own URL - differently from old aspx, where rules were sections on a single page.
5. Add the URL <dl class="image"><dt> <img alt="Create Rule" src="create-rule2.jpg" style="margin:5px;"> </dt></dl>    **Note:** We use only the most important words of a rule title. The words in **purple** are typically not used.
...
6. Add the rule title <dl class="ssw15-rteElement-ImageArea"> <img alt="Create Rule" src="create-rule3.jpg" style="margin:5px;"> </dl>
7. Add the rule category (so that it will be shown on the summary page): <dl class="ssw15-rteElement-ImageArea"> <img src="add-rule-category.jpg" alt="add-rule-category.jpg" style="margin:5px;width:650px;"> </dl>
...
10. Add the rule content <dl class="image"><dt> <img alt="Create Rule" src="create-rule15.jpg" style="margin:5px;"> </dt></dl>
11. [Add the acknowledgements](/Pages/add-acknowledgements-to-rules.aspx) <dl class="image"><dt> <img alt="Create Rule" src="create-rule16.jpg" style="margin:5px;"> </dt></dl>
12. Hit “Publish”, add your comments and “Continue” <dl class="image"><dt> <img alt="Create Rule" src="create-rule17.jpg" style="margin:5px;"> </dt></dl>    **Note:** "Check in a major version" **equals** "Publish", so you can choose to "Check in a major version" instead of "Publish".
