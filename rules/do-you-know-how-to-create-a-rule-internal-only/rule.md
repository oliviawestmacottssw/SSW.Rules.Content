...
6. Add the URL![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule2.jpg)    Note: We use only the most important words of a rule title. The words in **purple** are typically not used.
...
![auto-generate-friendlyurl.jpg](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/Pages/how-to-create-a-rule/auto-generate-friendlyurl.jpg)
7. Add the rule title![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule3.jpg)
8. Add the rule category (so that it will be shown on the summary page):![add-rule-category.jpg](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/Pages/how-to-create-a-rule/add-rule-category.jpg)
...
![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule6.jpg)Figure: Add the styles. In SharePoint is very similar to Microsoft Word. The custom styles will have pretty much everything you'll need without having to touch the HTML code
    3. **Option 3** - Paste the HTML code (recommended if you already have the content in the internet and the HTML is neat enough)
        ...
        4. In the “Format Text” ribbon, click “Edit Source”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule7.jpg)
        5. Paste the HTML there![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule8.jpg)
        6. Now fix up the images – This part is a bit painful
            ...
            - Instead, upload them to the Images folder - http://rules.ssw.com.au/PublishingImages/
                - Go to “Site Contents”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule9.jpg)
                - Click on “Images”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule10.jpg)
                - Drag the images from your local drive to the Images folder in SharePoint:![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule11.jpg)
                - Make sure you “Check In” all the images (otherwise they won’t be visible for anonymous users)![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule12.jpg)
...
11. Add the rule content![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule15.jpg)
12. Add the acknowledgements![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule16.jpg)
13. Hit “Publish” and “Continue”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule17.jpg)
14. Test on a browser you aren’t logged in. 
Tip: In Chrome, select “New Incognito Window”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule18.jpg)
...
Tip: You might need to refresh the cache – See “Rule Cache Management”![Create Rule](/Communication/Rules-to-Better-Adding-Rules/PublishingImages/create-rule19.jpg)
