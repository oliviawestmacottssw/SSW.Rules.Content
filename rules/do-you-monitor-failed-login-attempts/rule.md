...
![ This P​assive Monitor can then be applied to your Servers](failed-login-whatsup-gold-1.png)

[[goodExample]]
| ![This Passive Monitor will then record failed login attempts​It is important to also ensure that you have "Audit logon events" Group Policy applied to servers for source information on the login. ](failed-login-whatsup-gold-2.png)
