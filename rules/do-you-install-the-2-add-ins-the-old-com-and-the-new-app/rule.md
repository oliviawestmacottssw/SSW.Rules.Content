...
2. Select Settings (cog) | Apps For Dynamics 365
 ![crm-addins_1.png](crm-addins_1.png) Figure: Select Settings (cog) | Apps for Dynamics 365 ﻿menu﻿ item
...
You can optionally install the new App (ask you SysAdmin for help if you're unable to get it working)﻿
 ![crm-addins_2.png](crm-addins_2.png) Figure: Dynamics 365 apps for Outlook﻿. Note the words "lightweight" and "full"
...
6. You should now see the COM add-in within Outlook﻿
 ![crm-addins_3.png](crm-addins_3.png) Figure: Outlook showing the COM Add-ins installed and enabled﻿﻿
7. You should now see the Dynamics 365 plugins available within Outlook﻿ (e.g. emails & appointments) 
 ![crm-addins_4.png](crm-addins_4.png) Figure: In Outlook open a new Email and see both the Dynamics 365 app and the COM add in
