...
More: [https://docs.microsoft.com/en-us/office365/securitycompliance/keyword-queries-and-search-conditions](https&#58;//docs.microsoft.com/en-us/office365/securitycompliance/keyword-queries-and-search-conditions)
![filter-sharepoint-example.png](/PublishingImages/filter-sharepoint-example.png)Figure: Example of using Filetype: filter3. Use Boolean OR and AND operators
