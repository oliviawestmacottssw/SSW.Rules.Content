...
<dl class="image"><dt> <img class="ms-rteCustom-ImageArea" alt="NOT Done Email" src="NotDone.jpg"> </dt><dd>Figure: Not Done Email </dd></dl>
...
<dl class="badImage"><dt> <img class="ms-rteCustom-ImageArea" alt="Bad Done Email" src="email_done_bad.JPG"> </dt><dd>Figure: Bad Example of a "Done" email.</dd></dl><dl class="goodImage"><dt> <img class="ms-rteCustom-ImageArea" alt="Good Done Email" src="email_done_good.JPG"> </dt><dd>Figure: Good Example of a "Done" email as it has both the link and the changed text.</dd></dl>
