...
[[badExample]]
| ![Xamarin project targeting a single platform](xamarin-platform-bad.png)
...
[[goodExample]]
| ![cross-platform mobile app targeting iOS and Android with a shared codebase](xamarin-platform-good.png)
