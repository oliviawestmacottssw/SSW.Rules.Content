...
![using-capture-hardware-bad.png](using-capture-hardware-bad.png)Figure: Bad Example - Presenters View in PowerPoint auto changes the screen mode to 'Extended' 
### ​Good example
...
![using-capture-hardware-good.png](using-capture-hardware-good.png)Figure: Good Example - Hardware capture lets you record exactly what you want, and is ready for editing
