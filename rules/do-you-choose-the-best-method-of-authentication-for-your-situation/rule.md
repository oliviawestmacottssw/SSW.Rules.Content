...
<p class="ssw15-rteElement-P">​​Choosing the right 
   <a href="https&#58;//www.youtube.com/watch?v=i0d9iTmWIOw">authentication and authorisation</a> approach for your situation can be tricky. It is a multi-facted problem with many variables, and what seems like the right choice in one situation may not be in the other.<br></p><h3 class="ssw15-rteElement-H3">Start with the Questions​</h3><p class="ssw15-rteElement-P">
   <br>
</p><p class="ssw15-rteElement-P"></p><ol><li>Is it an enterprise application for internal user&#160;or a consumer application for external use?<br></li><li>Do you need to support 
      <a href="https&#58;//oauth.net/2/">OAuth2</a>&#160;or 
      <a href="https&#58;//openid.net/connect/">OICD</a>?<br></li><li>Do you need to support 
      <a href="https&#58;//en.wikipedia.org/wiki/Multi-factor_authentication">MFA</a>?<br></li><li>Do you need to share the identity across multiple applications?</li><li>Do you have an estimate for how many users you need to support?​</li></ol><p></p><p class="ssw15-rteElement-P">Without the answers to these questions, it will be difficult to choose the right option. With the answers to these questions, you can use the flow charts below to help you choose the right solution.<br></p>
   <br>
   <br>
<p class="ssw15-rteElement-P">
   ...
   <strong>Figure&#58; WebAPI (Internal Enterprise Application) - Authentication selection flow chart</strong><br></p><p class="ssw15-rteElement-P">Note #1&#58; Assuming an ASP.NET Core application with ASP.NET Core Identity<br></p><p class="ssw15-rteElement-P">Note #2&#58; Consider other factors too when making your decision, e.g. cost, potential crossover scenarios, etc.<br></p><h3>Example #1&#58; External Application<br></h3><p class="ssw15-rteElement-GreyBox">
    <strong>Scenario&#58;</strong><br> You are building a consumer facing service that will have multiple clients, including a SPA and a mobile app.
    <br>You want to allow your users to sign up with their social identities (Google, Facebook, Twitter, etc.) but want to allow them to create an account with you if they don't have a social login or don't want to use it.
    <br>All users will have the same level of access once logged in.
    <br>You are anticipating in excess of 20,000 active users per month. 
    <br> 
    <strong>Options&#58;</strong><br> 
    A) Auth0 (recommended) Auth0<br>
    B) Azure AD B2C<br>
    C) Identity Server<br> ​ </p><dd class="ssw15-rteElement-FigureBad">
    ...
    <h3>Example #2&#58; External Application<br></h3><p class="ssw15-rteElement-GreyBox">
        <strong>Scenario&#58;</strong><br> You are building a consumer facing service that will have multiple clients, including a SPA and a mobile app.
        <br> You want to allow your users to sign up with their social identities (Google, Facebook, Twitter, etc.) but want to allow them to create an account with you if they don't have a social login or don't want to use it.
        <br>All users will have the same level of access once logged in.
        <br>You would like to allow users to enable MFA.
        <br> 
        <strong>Options&#58;</strong><br> 
        A) Auth0 <br>
        B) Azure AD B2C (recommended)<br>
        C) Identity Server<br> ​ </p><dd class="ssw15-rteElement-FigureGood">
        <strong>Good Example&#58; The chosen solution meets the requirements<strong></strong></strong></dd> 
     <br>

    <h3>Example #3&#58; Internal Application<br></h3><p class="ssw15-rteElement-GreyBox">
        <strong>Scenario&#58;</strong><br> You have an internal enterprise application, which will support approxiamtely 1,000 users.
        ...
        <br>As per your company security policy, you must enforce MFA. 
        <br> 
        <strong>Options&#58;</strong><br> 
        A) Azure Active Directory (recommended)<br>
        B) Active Directory<br>
        C) Okta<br> ​ </p><dd class="ssw15-rteElement-FigureGood">
...
<ul><li>You want a side project to learn more about how you might roll your own, but of course you know never intend to put it into production &#58;-)​</li></ul><p></p>
