...
[[goodExample]]
| ![ Good Example - Options menu in Outlook, with ellipsis](../../assets/Elipsis.gif)

[[goodExample]]
| ![ Good Example - Ellipsis on buttons that require further input](../../assets/RunDialog.gif)

[[goodExample]]
| ![ Good Example - Different ways of using the elipsis](../../assets/GoodElipsis3.png)

[[goodExample]]
| ![ Good Example - Elipsis being used on a button requiring user input](../../assets/GoodElipsis4.png)
