...
<!--endintro-->
![track-email-in-outlook.png](track-email-in-outlook.png)


 **Figure: Track an Emails in OWA with Dynamics 365 App** ![track-email-in-owa.png](track-email-in-owa.png) **Figure: Track an Email in Outlook with Dynamics 365 App**
