...
2. Is the PBI ready?
Check your PBI against your <br>      [Definition of Ready](/Definition-of-Ready). "Ready" PBIs must have Acceptance Criteria. A good Definition of Ready also encourages a test-first mentality in requirements e.g. Use Spec Flow (Given, When, Then) and/or create Test Cases and Test Steps first.
...
3. Use [Microsoft's "Test and Feedback" Chrome extension](/Do-you-do-exploratory-testing1217-6487) to test the app
...
6. Email notification to the Product Owner – send a <br>      [Done Email (reply to the original)](/Done-GiveDetailsAndDelete). Big items should have a <br>      [Done Video](/Do-you-send-done-videos)
