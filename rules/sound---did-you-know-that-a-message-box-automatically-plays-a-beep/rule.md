...
---
 ...
 ![Windows plays sounds for message boxes](../../assets/Win7SoundError.png)Figure: Good Example - Windows message boxes plays a sound... which cannot be captured in screenshot form.   ​
