...
<p>SSW has a daily budget to spend on Twitter, Facebook, LinkedIn, Google Ads and Bing. At times we swap the budget from one platform to another to increase our conversions if the campaign is doing exceptionally well.<br></p><p>The best way to keep track of the monthly spend and make sure we don't go over our budget for the month is to hold a weekly meeting every Monday. The following spreadsheet <a href="/AnalyticsReports/Campaign%20PPC%20Spend.xlsx"><img class="ms-asset-icon ms-rtePosition-4" src="icxlsx.png" alt="" style="margin:5px;" />Campaign PPC Spend.xlsx</a> should be prepared before the meeting for stakeholders to review.</p><p>During the meeting we cover the following:</p><ol><li>The spend for the last week<br></li><li>The spend for the upcoming week</li></ol><p>At the end of the meeting, the spreadsheet is emailed to the stakeholders. The email should contain:</p><ol><li>The amount to be spent on each campaign on each platform</li><li>A link to the spreadsheet on your internal intranet - hopefully, SharePoint :-) <br></li></ol><p> </p>
