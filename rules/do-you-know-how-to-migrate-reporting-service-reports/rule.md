...
- Find creators of those reports, by clicking “Detail Views” in reports folder<br>      ![ Find reports creators by clicking "Details View" inside report folder](detailsview.png)
- Send an email to report creater ask for permission to delete 
![  Send an email to ask permission![receive.png](receive.png)](sent.png) 
