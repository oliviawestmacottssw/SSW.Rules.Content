...
 eg. (Adding Drew to the loop as during the daily scrum today he mentioned he has worked on similar issues and might have some input)
​
 ![Adding A Person To CC Good Example](/Communication/RulesToBetterEmail/PublishingImages/AddingPersonToCcGoodExample.png)Figure: Good Example - Adding someone to an email thread
