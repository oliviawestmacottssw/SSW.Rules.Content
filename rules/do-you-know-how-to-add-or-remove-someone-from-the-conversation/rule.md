...
​
 ![Adding A Person To CC Good Example](AddingPersonToCcGoodExample.png)Figure: Good Example - Adding someone to an email thread
...
![Add Recipient](RemoveRecipient.jpg)​ Figure: Good Example – Removing someone from an email thread so you can talk about the them in private
...
![Add Recipient](move-bcc.jpg)​ Figure: Good Example – Moving someone to BCC
