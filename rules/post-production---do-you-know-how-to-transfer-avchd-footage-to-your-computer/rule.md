...
2. The utility works by creating a database of all files that are transferred to your computer. You have to select folders that the software will ‘register’ as its destination folder. Before launching the program, you need to create a destination folder.
    ...
    - A dialogue will prompt you to navigate to your destination folder. Navigate to the ‘Capture\_Dump’ folder you created in step ‘1’ and select it. If you do not get this prompt, select the ‘Register Folders to View’ button on the top left of the window: ![Step 2.bmp](Step 2.bmp)
3. Connect the camera to your computer, and using the LCD, press 'USB Connect  ![Step 3.bmp](Step 3.bmp)
4. Open the ‘Content Management Utility’. Click on the camera icon on the top left of the window to open a new transfer window:  ![Step 4.bmp](Step 4.bmp)
5. In the new import window:
 ...
 ![Step 5.bmp](Step 5.bmp) 6. Finally, select the ‘Import’ button on the bottom right of the screen:  ![Step 6.bmp](Step 6.bmp)
