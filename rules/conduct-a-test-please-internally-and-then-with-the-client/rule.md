...
5. [Triage](/DoYouSendaSprintForecastAndReview) emails as they come in for completion in this release, or a later release.
...
**Note:** If the test to be performed is quick and the tester is available on the spot, consider using a "[checked by](/EmailCheck)" style instead to save some time.
