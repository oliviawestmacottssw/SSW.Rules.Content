...
​​​​Make sure appointments have address details unless it's obvious for all attendees.
 ![Bad location](appointment-location-bad-example.jpg) Figure: Bad Example - Appointment field should have addresses in location when appropriate
![map example.png](map example.png)Figure: Good example - Address is clearly identified in the location field, meaning it can be mapped using applications on smartphones 
