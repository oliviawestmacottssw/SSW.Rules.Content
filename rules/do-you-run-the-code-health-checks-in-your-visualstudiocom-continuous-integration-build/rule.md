...
​​​​​
![](VSO-Build-Good-1.png)Figu​​re: ​Good Example - Build Passing with no summa​​​ry issues
​​​
...
![ Good Examp​​​​​​le - Steps ​​added to build definition.](VSO-BuildDefinition-V3.png)

​​​​
![ Exa​mp​​​le director​​y for TSLint run commands](VSO-DirectoryExampleV2.png)
...
![ Command line​ s​​​tep to remove the config file ](VSO-RemoveConfig.png)
...
​
![](VSO-Build-Bad-1.png)Figu​re: Bad Code with a Good Code Health Implementation​ - B​uild broke due to com​​​pile errors. Must fix to proceed.​​​​
![](VSO-Build-Ok-1.png)​​​​​​​​​​Figure: Bad Code with a Good Code Health Implementation - ​Successful​​​​ build with warnings. ​These should be reprioritised as errors, or removed​
​​​​​​​​
![](VSO-Build-Good-1.png)​​​​​​​​​Figure:  Good Code with a Good Code Health Implementation - Successful​ build with ​​​no warnings.
