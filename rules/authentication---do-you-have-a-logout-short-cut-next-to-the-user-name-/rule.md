...
​                     Although most of the sites have a 'Log o​ff' submenu, we recommend adding a short                     cut next to the user name, this will make the 'log Off' operation more convenient.
 ![Bad example - only has a 'Log Off'](logoff-bad.jpg)                        Figure: Bad example - Only has a 'Log Off' operation in the submenu![Good example - has a 'Logout'](logoff-good.jpg)​                        Figure: Good example - Has a 'Logout' short cut next to the user name​​  
