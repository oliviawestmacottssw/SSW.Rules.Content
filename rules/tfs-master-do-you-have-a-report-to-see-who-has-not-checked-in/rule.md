...
<!--endintro-->
![Source Safe VS.NET](SideKicksStatus.jpg)Suggestion for TFS Sidekicks: Add a button to “Email all people their shame list”…. showing their files that are still checked out (until then I do it manually)Figure: Use TFS Sidekicks and search for files older than 48 hours to find the naughty boys.
