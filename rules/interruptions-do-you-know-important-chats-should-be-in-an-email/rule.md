...
If you get an internal IM that should be an email, don't simply convert it into in an email as above - [be a standard](/StandardsWatchdog)[watchdog](/StandardsWatchdog) and let the other person know that they should send emails instead of instant messages:
