...
**Figure: Code that should only run in Debug mode, we certainly don't want this in the release version.**![Debug configuration](DebugConfiguration.gif) **Figure: Set "Generate Debugging Information" to True on the project properties page (VS 2003).**![Advanced Build Settings](VS2005AdvancedBuildSettings.gif) **Figure: Set "Debug Info" to "pdb-only" on the Advanced Build Settings page (VS 2005).**
