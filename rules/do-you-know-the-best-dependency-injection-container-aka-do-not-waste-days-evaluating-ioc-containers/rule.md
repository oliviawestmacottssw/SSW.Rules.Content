...
[[goodExample]]
| ![the web / mvc integration package layer for Autofac is developed by the same core Autofac team. Some containers](Autofac_web.png)(such as Structure Map) require third-party integration layers   
