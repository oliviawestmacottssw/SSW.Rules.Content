...
![ Creating a project from the command line![create-angular-via-vs.jpg](create-angular-via-vs.jpg)](create-angular-via-cmd.png)
...
![ A simple example WebAPI![angular-ui-with-bootstrap.jpg](angular-ui-with-bootstrap.jpg)](simple-example-webapi.jpg)
