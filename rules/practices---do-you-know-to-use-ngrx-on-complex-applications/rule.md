...
NgRx is the redux pattern implemented for Angular.        [View on GitHub](https://github.com/ngrx).
  ...
  ![ngrx.png](ngrx.png) Figure: NgRx supercharges the redux pattern with RxJS 
...
- Code that is easy to test
 ...
 ![img1.png](img1.png) Figure: NgR​x supercharges the redux pattern with RxJS 
![img2.png](img2.png)Figure: The redux pattern is a way to implement a predictable state container
