...
---
 ...
 When you embed a YouTube video it will increase your page size from 500kbs to 1.5Mb or more, depending on how many videos are embedded on the page.
  ...
  ![video-embed-load-time.png](video-embed-load-time.png) Figure: A side by side comparison – everyone wants less requests and a smaller page size![video-embed-bad.png](video-embed-bad.png)  Figure: Bad example - Don’t add embed code directly from YouTube. For more details [read "A Better Method for Embedding YouTube Videos on your Website"](https://www.labnol.org/internet/light-youtube-embeds/27941/)
