...
![ From the CRM home screen, hover your mouse over “Workplace”, and then click “Contacts” in the menu that drops down![crm02.png](crm02.png)](crm01.png)
![ then select "Results" to bring up contacts which match your search query![crm05 - contacts list.png](crm05 - contacts list.png)](crm04 - results.png)
2. First time only, save this as a System View. You will need a SysAdmin for this.
3. Create the newsletter in Microsoft CRM 2013 using a <br>            **Quick Campaign**![ Select "For All Records on All Pages" to create a Quick Campaign from the current contact list. This will bring up a Quick Campaign Wizard](crm06 - create quick campaign.png)
![ Click Next and then specify the name of the quick campaign.![Select the Activity Type and Owner](crm08- own quick campaign.png)](crm07 - name quick campaign.png)
