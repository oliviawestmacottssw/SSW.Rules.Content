...
![crm01.png](/PublishingImages/crm01.png)Figure: <br>            **From the CRM home screen, hover your mouse over “Workplace”, and then click “Contacts” in the menu that drops down **![crm02.png](/PublishingImages/crm02.png)Figure: F**rom the “Activities” page, click “…” | “Advanced Find”. This will activate a pop-up.**![crm03.png](/PublishingImages/crm03.png)Figure: **Select Contacts at Look For and specify a set of criteria to search for newsletter contacts.****
****![crm04 - results.png](/PublishingImages/crm04%20-%20results.png)****Figure: then select "Results" to bring up contacts which match your search query **

![crm05 - contacts list.png](/PublishingImages/crm05%20-%20contacts%20list.png)
...
3. Create the newsletter in Microsoft CRM 2013 using a <br>      **Quick Campaign**.![Create Quick Campaign](/PublishingImages/crm06%20-%20create%20quick%20campaign.png)
...
![Specify name of quick campaign](/PublishingImages/crm07%20-%20name%20quick%20campaign.png)Figure: Click Next and then specify name of quick campaign.![Select the Activity Type and Owner](/PublishingImages/crm08-%20own%20quick%20campaign.png)Figure: Select the Activity Type and Owner.![Fill in newsletter Content](/PublishingImages/crm09%20-%20add%20content.png)Figure: Fill in newsletter content.
