...
SSWSugarLearningEvents
 ...
 SSWLinkAuditorDevs
<dd class="ssw15-rteElement-FigureBad"> Figure&#58; Bad Example – It is difficult to know the correct name for an AD group </dd>
SSWSugarLearning
 SSWSugarLearningEvents
 SSWCodeAuditor
...
​  <dd class="ssw15-rteElement-FigureGood"> Figure&#58; Good Example – By standardizing the names of AD groups it saves confusion<br></dd>
**
