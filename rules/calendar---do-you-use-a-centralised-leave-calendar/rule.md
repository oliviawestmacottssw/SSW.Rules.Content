...
Since this is just a calendar, you should also send these leave requests to your admin managers, so they are always notified of what's going on, although normally these managers will delete the notification rather than add it to their own calendar by accepting it. At SSW, we use the SSWAdmin group alias for this.
