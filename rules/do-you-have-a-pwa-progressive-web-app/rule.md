...
![pwa-bad-example.jpg](pwa-bad-example.jpg)Figure: Bad Example - aliexpress get a mark of 6/12 (see tooltip) and cannot be used as a PWA![pwa-example.png](pwa-example.png)
Figure: Accessing a PWA on your mobile will prompt adding it on your Home s​creen. E.g. [https://blog.mikemjharris.com](https://blog.mikemjharris.com/)
