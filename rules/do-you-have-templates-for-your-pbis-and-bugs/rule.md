...
[[goodExample]]
| ![ Good Example – This new bug template guides the user to fill in the steps to repro in an ordered list and even prompts them to fill in what they expected to happen ](templates for pbis and bugs - good example.png)
(and what actually happened)
Setting this up is pretty easy.

1. First you need to customise the template for a work item type 
![](templates for pbis and bugs - customise.png)​Figure: Customising a bug work item
...
![ Set the default value for the Repro Steps field ](templates for pbis and bugs - customise default value.png)
(tip: use HTML)
4. Save Template​
