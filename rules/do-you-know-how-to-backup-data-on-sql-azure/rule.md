...
Figure: Bad example - Using T-SQL to restore your database![Azure-restore.jpg](Azure-restore.jpg)Figure: Good example - Using the built in SQL Azure Database automatic backup system to restore your database
