...
Figure: Good Example - Using serilog allows persisting structured log data to multiple<br>stores, querying that data intelligently and requires less work to install and configure than a roll-you-own logger, and provides many more features
