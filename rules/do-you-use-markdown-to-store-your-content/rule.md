...
[[badExample]]
| ![ HTML generated by a rich editor gets harder to maintain over time.​ ​This link shows many things that have to be fixed in bad HTML: ](HTML-bad.jpg)
[https://www.diffchecker.com/CIGu4K19​](https://www.diffchecker.com/CIGu4K19).​​  
...
[[okExample]]
| ![ OK Example – you can use raw HTML in your Markdown, and mostly it will work pretty well. But you can’t use Markdown’s syntactic sugar in the HTML](use-html-in-markdown.png)

The other way is to use templates or containers:

[[badExample]]
| ![ Bad Example – The danger of using HTML in your Markdown files is that you add too much formatting e.g. use Bootstrap classes that create tight coupling between the content and the presentation](danger-html-and-markdown.png)
