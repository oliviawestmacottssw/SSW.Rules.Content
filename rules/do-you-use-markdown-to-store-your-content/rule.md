...
<dl class="image"><dt> 
   ...
   </dt><dd>Figure: "Edit" button to encourage users updating the content<br></dd></dl>
...
<dl class="image"><dt><img src="markdown.jpg" alt="markdown.jpg"><br></dt></dl>
...
<dl class="badImage"><dt>
   ...
   </dt><dd>Figure: Bad example - HTML generated by a rich editor gets harder to maintain over time.</dd></dl> This link shows many things that have to be fixed in bad HTML: https://www.diffchecker.com/CIGu4K19.  
...
<dl class="goodImage"><dt>
   ...
   </dt><dd>Figure: Good example - Markdown looks clean<br></dd></dl>
...
<dl class="badImage"><dt> 
   ...
   </dt><dd>Figure: Bad Example – The danger of using HTML in your Markdown files is that you add too much formatting e.g. use Bootstrap classes that create tight coupling between the content and the presentation</dd></dl>
