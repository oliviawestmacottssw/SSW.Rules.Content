...
![edit-button.jpg](edit-button.jpg)Figure: "Edit" button to encourage users updating the ​content​
...
Watch the video where Thiago explains the benefits of using Markdown: <br>
...
![HTML-bad.jpg](HTML-bad.jpg)Figure: Bad example - HTML generated by a rich editor gets harder to maintain over time.​ ​This link shows many things that have to be fixed in bad HTML: [https://www.diffchecker.com/CIGu4K19​](https://www.diffchecker.com/CIGu4K19).​​  
...
- [​​ProseM​irror](http://prosemirror.net/)​​
...
![markdown-good.jpg](markdown-good.jpg)Figure: Good example - Markdown looks clean
...
![use-html-in-markdown.png](use-html-in-markdown.png)Figure: OK Example – you can use raw HTML in your Markdown, and mostly it will work pretty well. But you can’t use Markdown’s syntactic sugar in the HTML
The other way is to use templates or containers:
![danger-html-and-markdown.png](danger-html-and-markdown.png)Figure: Bad Example – The danger of using HTML in your Markdown files is that you add too much formatting e.g. use Bootstrap classes that create tight coupling between the content and the presentation
A better way is to use a plugin (if your Markdown engine supports it).
![vuepress-custom-container.png](vuepress-custom-container.png)Figure: Good Example – VuePress has a custom container that generates nice alert boxes like Bootstrap but without tying the presentation to the CSS framework in the content
...
![YouTube Embed Workaround.png](YouTube Embed Workaround.png)
...
![YouTube Embed with Plugin.png](YouTube Embed with Plugin.png)
​​Figure: Better Example - YouTube video embedding using plugin​​​

### Markdown to HTML rendering processes

![markdown-rendering.jpg](markdown-rendering.jpg)Figure: The markdown rendered either Client-side or Server-side
