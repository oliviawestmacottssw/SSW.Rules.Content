...
<h3 class="ssw15-rteElement-H3">​#1 Laptop and cast to a monitor (recommended)</h3><p>This could then be screen-shared for remote meeting attendees&#160;and is easily saveable/sharable for later.<br></p><ul><li>PowerPoint</li><li>Visio<br></li><li>OneNote<br></li><li> 
      <a href="https&#58;//mural.co/" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Mural</a>&#160;(collaborative app)<br></li><li>diagrams.net ​(was draw.io) -&#160;you don’t always have a beautiful architecture diagram​<br></li><li>Microsoft Teams Whiteboard​​​​​<br>
     <dl class="image"><dt>​ 
       ...
       &#160;</div></dt>​ 
      <dd>Figure&#58; Using Microsoft T​​eams Whiteboard feature</dd></dl></li>
</ul>​<h3 class="ssw15-rteElement-H3">#2 Tech Whiteboard replacement<br></h3><ul><li> 
      ...
      <dl class="image"><dt><div class="ms-rtestate-read ms-rte-embedcode ms-rte-embedil ms-rtestate-notify" unselectable="on"> 
               <iframe width="750" height="390" src="https&#58;//www.youtube.com/embed/fgp_ntJ0nA4" frameborder="0"></iframe><br unselectable="on">
            </div> 
          ​​​​</dt><dd> Figure&#58; Using Samsung Flip​ </dd></dl><dl class="image"><dt> 
            <img src="/PublishingImages/samsung-flip.png" alt="Flip-whiteboard2.jpg" style="width&#58;518px;height&#58;470px;" /> 
         </dt><dd>​​​Figure&#58;&#160;Samsung flipchart can be flipped from horizontal to vertical​​​</dd></dl></li><li> 
      <b>Microsoft Surface Hub 2</b>&#160;(about $9K)<br> 
