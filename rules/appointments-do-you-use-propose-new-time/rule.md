...
[[badExample]]
| ![The person who sent the appointment has to interpret your message, then go back in and edit the appointment](decline.png)
Instead of simply declining the message and typing your proposed time in the message body, propose a new time as follows:

[[goodExample]]
| ![The new time is proposed, and the person who sent the original appointment can easily accept your proposal](Propose-new-time.png)(or view all proposals if there are multiple recipients)
