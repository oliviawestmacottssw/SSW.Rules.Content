...
![Use References Folder](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_referencesfolder.jpg) Figure: 'References' folder
...
<br>    I select both the dll and the dll.xml files, right-click and drag them into my $/ssw/zzRefs/References/ folder that I just created in step 1. ![Use Dlls Xml](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_dllsxml.jpg) Figure: Select the dlls that I want to use ![Use right click to share](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_rightclicktoshare.jpg) Figure: Right drag, and select "Share"
3. Still in SourceSafe, select the References folder, run get latest?to copy the latest version onto your working directory.
![Use Get Latest](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_getlatest.jpg) Figure: Get Latest from Visual Source Safe VSS may ask you if you want to create the folder, if it doesnt exist. Yes, we do.
...
![Use Include Invs](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_includeinvs.jpg) Figure: Include the files into the current project
...
![Use Undo Checkout](/Standards/SoftwareDevelopment/RulesToBetterDotNETProjects/PublishingImages/use_undocheckout.jpg) Figure: Undo Checkout, when VS.NET checked them out for you...
