...
​Figure: Bad Example – The email is using a screensho​​t so that is good, but you need to read the text and relate it to the image

![Check the shadow properties](/PublishingImages/BalloonGoodExample.jpg)
Figure: Good Example – The balloon with text on the screenshot, makes it quicker to understand <br>
...
​Figure: Goo​​d Example – See 3 balloons were not needed ![arrow_example2.png](/SiteAssets/screenshots-do-you-use-balloons-instead-of-a-wall-of-text/arrow_example.png) ​
Figure: Good Example - Sometimes an arrow is all t​​hat is n​eeded​​
