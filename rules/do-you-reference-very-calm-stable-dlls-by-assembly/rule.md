...
<ol>
    <li>First, we need to get the folder and add it to our project, so in SourceSafe, right click your project and create a subfolder using the Create Project (yes, it is very silly name) menu. <img class="ms-rteCustom-ImageArea" alt="Use Create VSS Folder" src="use_createvssfolder.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Create 'folder' in Visual Source Safe</span>
    <p>Name it References</p>
    <img class="ms-rteCustom-ImageArea" alt="Use References Folder" src="use_referencesfolder.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: 'References' folder</span> </li>
    ...
    I select both the dll and the dll.xml files, right-click and drag them into my $/ssw/zzRefs/References/ folder that I just created in step 1. <img class="ms-rteCustom-ImageArea" alt="Use Dlls Xml" src="use_dllsxml.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Select the dlls that I want to use</span> <img class="ms-rteCustom-ImageArea" alt="Use right click to share" src="use_rightclicktoshare.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Right drag, and select "Share"</span> </li>
    ...
    <img class="ms-rteCustom-ImageArea" alt="Use Get Latest" src="use_getlatest.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Get Latest from Visual Source Safe</span> VSS may ask you if you want to create the folder, if it doesnt exist. Yes, we do. </li>
    ...
    <img class="ms-rteCustom-ImageArea" alt="Use Include Invs" src="use_includeinvs.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Include the files into the current project</span> </li>
    ...
    <img class="ms-rteCustom-ImageArea" alt="Use Undo Checkout" src="use_undocheckout.jpg" /> <span class="ms-rteCustom-FigureNormal">Figure: Undo Checkout, when VS.NET checked them out for you...</span> </li>
