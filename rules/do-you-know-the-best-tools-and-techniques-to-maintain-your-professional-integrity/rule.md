...
Seeing as professional integrity doesn't just mean getting work done, but getting it done within an agreed timeframe, you can use a free service called     [FollowUpThen](/FollowUpEmailsEffectively)to help in a number of ways
...
See more on the [to myself rule](/EmailToMyself).
...
See more on [Rules to Better Scrum](/Rules-to-Better-Scrum-using-TFS)
