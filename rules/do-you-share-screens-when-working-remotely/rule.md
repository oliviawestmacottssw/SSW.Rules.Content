...
For a list of our recommended screen sharing tools, please check the     [SSW rules for remote support](/Management/RulesToSuccessfulProjects/Pages/RemoteSupport.aspx).​

​Another good practice that follows on from this, is to leave a skype session open. This eliminates to need to call your programming partner every time you have a query or question to ask.
