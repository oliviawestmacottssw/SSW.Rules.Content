...
![Form with Arial Narrow Font](../../assets/FontBadArialNarrow.gif)Figure: Bad Example - This form uses a non-standard font, and it is hard to read![Form with Tahoma Font](../../assets/FontGoodTahoma.gif)Figure: Good Example - This form uses Tahoma, and it is easy to read![Form with Tahoma Font, and a RichTextBox with Courier New Font](../../assets/FontCourierNew.gif)Figure: Good Example - This form uses Tahoma, and the RichTextBox displays source code using Courier New
