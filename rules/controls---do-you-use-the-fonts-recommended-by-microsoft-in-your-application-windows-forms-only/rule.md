...
[[badExample]]
| ![ Bad Example - This form uses a non-standard font, and it is hard to read](../../assets/FontBadArialNarrow.gif)

[[goodExample]]
| ![ Good Example - This form uses Tahoma, and it is easy to read](../../assets/FontGoodTahoma.gif)

[[goodExample]]
| ![ Good Example - This form uses Tahoma, and the RichTextBox displays source code using Courier New](../../assets/FontCourierNew.gif)
