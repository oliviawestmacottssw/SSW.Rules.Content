...
![raygun-integration-tfs-1.png](raygun-integration-tfs-1.png)Figure: Link RayGun with TFS/VisualStudio.com
Now under the crash report, you have to option to create a PBI and link it to the crash report.
![raygun-integration-tfs-2.png](raygun-integration-tfs-2.png)Figure: Create a new PBI or link to an existing PBI
Now you can see which RayGun create reports have already been added to the backlog.
![raygun-integration-tfs-3.png](raygun-integration-tfs-3.png)Figure: Link RayGun with TFS/VisualStudio.com
