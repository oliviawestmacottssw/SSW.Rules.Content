...
<dd class="ssw15-rteElement-FigureNormal"><p class="ssw15-rteElement-GreyBox" style="text-align:center;">
      <img src="rules-to-better-inbox-management.png" alt="rules-to-better-inbox-management.png" style="margin:5px;"> </p><p class="ssw15-rteElement-P"><span style="color:#444444;"> Figure: Don't let your inbox become a vortex of doom - keep it organised!</span></p></dd>
